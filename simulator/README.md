...
6. Нажимайте `Шаг`, пока симуляция не пройдет Consul observation, health vector, matrix matching, optional Redfish fencing, Masakari notification, taskflow и evacuation.
