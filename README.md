...
7. Нажимайте `Шаг`, чтобы пройти нижний pipeline: Consul observe, Health vector, Matrix match, Redfish fencing, Masakari notification, Taskflow и Nova evacuate. При включенном fencing Redfish должен успешно завершиться до notification.
